...
| Route page hook | `web-dom` | [`apps/web/src/routes/sessions/__tests__/use-sessions-page.test.ts`](apps/web/src/routes/sessions/__tests__/use-sessions-page.test.ts) (route-local), [`apps/web/src/features/players/pages/players-page/__tests__/use-players-page.test.ts`](apps/web/src/features/players/pages/players-page/__tests__/use-players-page.test.ts) (`pages/` layout) |
