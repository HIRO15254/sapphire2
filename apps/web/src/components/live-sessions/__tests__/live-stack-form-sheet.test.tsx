...
vi.mock("@/components/live-cash-game/cash-game-stack-form", () => ({
	CashGameStackForm: ({
		onComplete,
	}: {
...
vi.mock("@/components/live-cash-game/cash-game-complete-form", () => ({
	CashGameCompleteForm: () => <div>Cash Complete Form</div>,
}));

vi.mock("@/components/live-tournament/tournament-stack-form", () => ({
...
vi.mock("@/components/live-tournament/tournament-complete-form", () => ({
