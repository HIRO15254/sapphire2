...
vi.mock("@/live-sessions/components/cash-game-stack-form", () => ({
	CashGameStackForm: ({
		onComplete,
	}: {
...
vi.mock("@/live-sessions/components/cash-game-complete-form", () => ({
	CashGameCompleteForm: () => <div>Cash Complete Form</div>,
}));

vi.mock("@/live-sessions/components/tournament-stack-form", () => ({
