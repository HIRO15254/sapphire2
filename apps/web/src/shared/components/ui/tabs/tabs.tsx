	...
	return (
		<TabsPrimitive.Trigger
			className={cn(
				...
				"group-data-[variant=default]/tabs-list:data-active:border-border data-active:bg-background data-active:text-foreground dark:data-active:border-input dark:data-active:bg-input/30 dark:data-active:text-foreground",
