...
function CashGameSessionPage() {
	...
	return (
		<div className="flex h-[calc(100dvh-4rem)] flex-col px-4 pt-2 pb-2 md:px-6 md:pt-4">
			{/* Compact header */}
			...
			{/* Action bar - fixed at bottom of the flex container */}
			{isActive && (
				<div className="flex gap-2 border-border border-t pt-2">
					<Button
						className="flex-1"
