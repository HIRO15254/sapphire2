...
import { useTournaments } from "@/features/rooms/hooks/use-tournaments";
...
export function useTournamentTab({ roomId }: UseTournamentTabOptions) {
	...
	} = useTournaments({ roomId, showArchived });
