...
import { PlayerAvatar } from "@/features/players/components/player-avatar";
...
import { useAddPlayerSearch } from "./use-add-player-search";
	...
	return (
		<Drawer onOpenChange={onOpenChange} open={open}>
			<DrawerContent className="h-[calc(100svh-2rem)] rounded-t-xl">
				...
				/>
				<DrawerTitle className="t-h4 px-4 pt-1">Add Player</DrawerTitle>
				<DrawerDescription className="sr-only">
					Search for an existing player or create a new one.
				</DrawerDescription>
				<div className="flex flex-1 flex-col gap-3 overflow-y-auto px-4 py-3 pb-[calc(1rem+env(safe-area-inset-bottom))]">
