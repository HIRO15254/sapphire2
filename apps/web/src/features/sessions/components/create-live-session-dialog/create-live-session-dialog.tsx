...
import { useCreateCashGameForm } from "./use-create-cash-game-form";
...
function CashGameSubForm({
	...
	} = useCreateCashGameForm({ onStoreChange, onSubmit, ringGames });
...
function TournamentSubForm({
	...
	const {
		...
		handleCurrencyChange,
	} = useCreateTournamentForm({ onStoreChange, onSubmit, tournaments });
