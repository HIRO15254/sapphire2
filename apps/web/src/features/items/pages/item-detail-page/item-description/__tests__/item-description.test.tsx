...
import { ItemDescription } from "@/features/items/pages/item-detail-page/item-description";
import { DESCRIPTION_COLLAPSED_MAX_PX } from "@/features/items/pages/item-detail-page/item-description/use-item-description";
...
describe("ItemDescription", () => {
	it("renders the Description heading and the rich-text content", () => {
		...
		render(<ItemDescription html="<p>Hello notes</p>" />);
		expect(
	...
	it("does not render a toggle when the content fits within the collapsed height", () => {
		mockScrollHeight = SHORT;
		render(<ItemDescription html="<p>short</p>" />);
		expect(
	...
	it("clamps the body to the collapsed max height by default", () => {
		...
		render(<ItemDescription html="<p>long</p>" />);
		expect(screen.getByTestId("item-description-body")).toHaveStyle({
	...
	it("animates the body height with a max-height transition", () => {
		mockScrollHeight = TALL;
		render(<ItemDescription html="<p>long</p>" />);
		expect(screen.getByTestId("item-description-body").className).toContain(
