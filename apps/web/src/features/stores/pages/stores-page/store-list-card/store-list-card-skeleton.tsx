...
/**
 * Loading placeholder for a single {@link StoreListCard}. Colocated with the
...
export function StoreListCardSkeleton() {
	return (
		<div className="flex h-12 items-center gap-3 rounded-lg border border-border bg-card px-4">
