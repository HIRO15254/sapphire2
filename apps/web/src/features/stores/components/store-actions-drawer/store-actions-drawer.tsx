...
interface StoreActionsDrawerProps {
	onDelete: () => void;
	onEdit: () => void;
...
/**
 * V2 action sheet for the store detail page header overflow, mirroring
 * `CurrencyActionsDrawer`: Edit / Delete the store itself.
 */
export function StoreActionsDrawer({
	onDelete,
	onEdit,
	onOpenChange,
	open,
}: StoreActionsDrawerProps) {
	return (
		<Drawer onOpenChange={onOpenChange} open={open}>
			<DrawerContent className="theme-v2 rounded-t-xl">
				...
				/>
				<DrawerTitle className="sr-only">Store actions</DrawerTitle>
				<DrawerDescription className="sr-only">
					Edit or delete this store.
				</DrawerDescription>
