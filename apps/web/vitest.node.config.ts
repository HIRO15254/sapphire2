...
export default defineConfig({
	...
	test: {
		...
		include: [
			...
			"src/features/live-sessions/utils/__tests__/create-tournament-session-form-helpers.test.ts",
			"src/features/live-sessions/utils/__tests__/game-scene-formatters.test.ts",
			"src/features/live-sessions/utils/__tests__/session-events-formatters.test.ts",
			"src/features/live-sessions/utils/__tests__/stack-editor-time.test.ts",
			"src/features/live-sessions/utils/__tests__/tournament-timer.test.ts",
			"src/features/live-sessions/utils/__tests__/seat-screenshot.test.ts",
